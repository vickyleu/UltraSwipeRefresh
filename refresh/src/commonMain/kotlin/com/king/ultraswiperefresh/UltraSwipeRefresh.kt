...
@Composable
internal expect fun rememberVibrator(): VibratorImpl
expect abstract class VibratorImpl{
    public abstract fun hasVibrator(): Boolean
}
@Suppress("DEPRECATION")
internal expect fun VibratorImpl.vibrate()
